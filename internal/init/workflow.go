...
// CheckTTY. NewInitWorkflowWithClient skips that check, and the only
// callers of WithClient + Run are tests using MockPrompter — production
// is funneled through NewInitWorkflow.

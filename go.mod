module github.com/koh-sh/apcdeploy
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/account v1.28.7
	github.com/aws/aws-sdk-go-v2/service/appconfig v1.42.7
	github.com/aws/aws-sdk-go-v2/service/appconfigdata v1.23.6
